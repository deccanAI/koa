...
module.exports = class Application extends Emitter {
   ...
   * This includes:
   * - Closing all active servers
   * - Cleaning up AsyncLocalStorage if used
   * - Removing all event listeners
   * 
   * @return {Promise} resolves when cleanup is complete
   * @api public
   */
  close() {
    debug('close')
    ...
    if (this.ctxStorage) {
      // AsyncLocalStorage doesn't have an explicit cleanup method
      // But we can help GC by removing our reference
